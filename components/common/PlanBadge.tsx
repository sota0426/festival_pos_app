...
const planConfig: Record<PlanType, { label: string; bg: string; text: string }> = {
  ...
  org_standard: { label: '団体10', bg: 'bg-purple-100', text: 'text-purple-700' },
  org_premium: { label: '団体30', bg: 'bg-fuchsia-100', text: 'text-fuchsia-700' },
  organization: { label: '団体10', bg: 'bg-purple-100', text: 'text-purple-700' }, // legacy
};
